...
# Precalcolo offset (come array NumPy per velocità)
...
def analyze_outliers(image3d):
    """
    Ottimizzata: calcolo dei top-5 outlier con media locale su vicini interni/esterni.
    """
    depth, width, height = image3d.shape

    # Padding: aggiungiamo margini per non dover fare controlli di bounds
