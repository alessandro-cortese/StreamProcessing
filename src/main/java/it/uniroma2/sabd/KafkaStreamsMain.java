...
public class KafkaStreamsMain {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(KafkaStreamsMain.class);
    private static final String KAFKA_TOPIC = "challenger-batches"; // Topic da cui leggere
    private static final String KAFKA_BOOTSTRAP_SERVERS = "localhost:9092"; // Indirizzo del broker Kafka

    public static void main(String[] args) {
        String bootstrapServers = args.length > 0 ? args[0] : System.getProperty("KAFKA_BOOTSTRAP_SERVERS", KAFKA_BOOTSTRAP_SERVERS);
